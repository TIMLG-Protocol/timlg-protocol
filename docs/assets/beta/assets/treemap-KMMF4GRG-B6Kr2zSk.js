...
import { ar as global, b9 as isEmpty$1, bC as process$1, bD as __vitePreload } from "./index-CxAYztMY.js";
import { m as map$2, f as flatten$1, d as min } from "./min-BdNnxJyE.js";
import { b as baseFlatten$1, l as baseUniq$1, d as baseIteratee$2, m as filter$1, r as reduce$1, n as forEach$2 } from "./_baseUniq-CDTLz2ZB.js";
function flatMap$1(collection, iteratee) {
  return baseFlatten$1(map$2(collection, iteratee));
}
function uniqBy(array, iteratee) {
  return array && array.length ? baseUniq$1(array, baseIteratee$2(iteratee)) : [];
}
...
var hasOwnProperty$s = objectProto$y.hasOwnProperty;
var nativeObjectToString$3 = objectProto$y.toString;
...
var nativeObjectToString$2 = objectProto$x.toString;
...
var symbolProto$4 = Symbol$2 ? Symbol$2.prototype : void 0, symbolToString$1 = symbolProto$4 ? symbolProto$4.toString : void 0;
...
var INFINITY$2 = 1 / 0, MAX_INTEGER$1 = 17976931348623157e292;
...
var funcProto$2 = Function.prototype, objectProto$w = Object.prototype;
var funcToString$2 = funcProto$2.toString;
var hasOwnProperty$r = objectProto$w.hasOwnProperty;
var reIsNative$1 = RegExp(
  "^" + funcToString$2.call(hasOwnProperty$r).replace(reRegExpChar$1, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
...
function assignValue$1(object, key, value) {
  ...
  if (!(hasOwnProperty$q.call(object, key) && eq$1(objValue, value)) || value === void 0 && !(key in object)) {
...
var isArguments$1 = baseIsArguments$1(/* @__PURE__ */ (function() {
  ...
  return isObjectLike$1(value) && hasOwnProperty$p.call(value, "callee") && !propertyIsEnumerable$3.call(value, "callee");
};
...
var Buffer$2 = moduleExports$4 ? root$1.Buffer : void 0;
var nativeIsBuffer$1 = Buffer$2 ? Buffer$2.isBuffer : void 0;
var isBuffer$1 = nativeIsBuffer$1 || stubFalse$1;
var argsTag$5 = "[object Arguments]", arrayTag$4 = "[object Array]", boolTag$5 = "[object Boolean]", dateTag$5 = "[object Date]", errorTag$4 = "[object Error]", funcTag$3 = "[object Function]", mapTag$9 = "[object Map]", numberTag$5 = "[object Number]", objectTag$6 = "[object Object]", regexpTag$7 = "[object RegExp]", setTag$9 = "[object Set]", stringTag$7 = "[object String]", weakMapTag$4 = "[object WeakMap]";
...
typedArrayTags$1[argsTag$5] = typedArrayTags$1[arrayTag$4] = typedArrayTags$1[arrayBufferTag$5] = typedArrayTags$1[boolTag$5] = typedArrayTags$1[dataViewTag$7] = typedArrayTags$1[dateTag$5] = typedArrayTags$1[errorTag$4] = typedArrayTags$1[funcTag$3] = typedArrayTags$1[mapTag$9] = typedArrayTags$1[numberTag$5] = typedArrayTags$1[objectTag$6] = typedArrayTags$1[regexpTag$7] = typedArrayTags$1[setTag$9] = typedArrayTags$1[stringTag$7] = typedArrayTags$1[weakMapTag$4] = false;
...
function arrayLikeKeys$1(value, inherited) {
  var isArr = isArray$1(value), isArg = !isArr && isArguments$1(value), isBuff = !isArr && !isArg && isBuffer$1(value), isType2 = !isArr && !isArg && !isBuff && isTypedArray$1(value), skipIndexes = isArr || isArg || isBuff || isType2, result = skipIndexes ? baseTimes$1(value.length, String) : [], length = result.length;
  for (var key in value) {
    if ((inherited || hasOwnProperty$o.call(value, key)) && !(skipIndexes && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var assign$1 = createAssigner$1(function(object, source) {
  ...
  for (var key in source) {
    if (hasOwnProperty$m.call(source, key)) {
...
function hashHas$1(key) {
  var data = this.__data__;
  return nativeCreate$1 ? data[key] !== void 0 : hasOwnProperty$j.call(data, key);
}
...
var getSymbols$1 = !nativeGetSymbols$3 ? stubArray$1 : function(object) {
  if (object == null) {
    return [];
  }
  object = Object(object);
...
var mapTag$8 = "[object Map]", objectTag$5 = "[object Object]", promiseTag$1 = "[object Promise]", setTag$8 = "[object Set]", weakMapTag$3 = "[object WeakMap]";
var dataViewTag$6 = "[object DataView]";
var dataViewCtorString$1 = toSource$1(DataView$1), mapCtorString$1 = toSource$1(Map$2), promiseCtorString$1 = toSource$1(Promise$2), setCtorString$1 = toSource$1(Set$2), weakMapCtorString$1 = toSource$1(WeakMap$1);
var getTag$1 = baseGetTag$1;
if (DataView$1 && getTag$1(new DataView$1(new ArrayBuffer(1))) != dataViewTag$6 || Map$2 && getTag$1(new Map$2()) != mapTag$8 || Promise$2 && getTag$1(Promise$2.resolve()) != promiseTag$1 || Set$2 && getTag$1(new Set$2()) != setTag$8 || WeakMap$1 && getTag$1(new WeakMap$1()) != weakMapTag$3) {
...
function initCloneArray(array) {
  ...
  if (length && typeof array[0] == "string" && hasOwnProperty$i.call(array, "index")) {
...
var symbolProto$3 = Symbol$2 ? Symbol$2.prototype : void 0, symbolValueOf$2 = symbolProto$3 ? symbolProto$3.valueOf : void 0;
...
var boolTag$4 = "[object Boolean]", dateTag$4 = "[object Date]", mapTag$7 = "[object Map]", numberTag$4 = "[object Number]", regexpTag$6 = "[object RegExp]", setTag$7 = "[object Set]", stringTag$6 = "[object String]", symbolTag$4 = "[object Symbol]";
var arrayBufferTag$4 = "[object ArrayBuffer]", dataViewTag$5 = "[object DataView]", float32Tag$2 = "[object Float32Array]", float64Tag$2 = "[object Float64Array]", int8Tag$2 = "[object Int8Array]", int16Tag$2 = "[object Int16Array]", int32Tag$2 = "[object Int32Array]", uint8Tag$2 = "[object Uint8Array]", uint8ClampedTag$2 = "[object Uint8ClampedArray]", uint16Tag$2 = "[object Uint16Array]", uint32Tag$2 = "[object Uint32Array]";
...
var argsTag$4 = "[object Arguments]", arrayTag$3 = "[object Array]", boolTag$3 = "[object Boolean]", dateTag$3 = "[object Date]", errorTag$3 = "[object Error]", funcTag$2 = "[object Function]", genTag$1 = "[object GeneratorFunction]", mapTag$5 = "[object Map]", numberTag$3 = "[object Number]", objectTag$4 = "[object Object]", regexpTag$5 = "[object RegExp]", setTag$5 = "[object Set]", stringTag$5 = "[object String]", symbolTag$3 = "[object Symbol]", weakMapTag$2 = "[object WeakMap]";
var arrayBufferTag$3 = "[object ArrayBuffer]", dataViewTag$4 = "[object DataView]", float32Tag$1 = "[object Float32Array]", float64Tag$1 = "[object Float64Array]", int8Tag$1 = "[object Int8Array]", int16Tag$1 = "[object Int16Array]", int32Tag$1 = "[object Int32Array]", uint8Tag$1 = "[object Uint8Array]", uint8ClampedTag$1 = "[object Uint8ClampedArray]", uint16Tag$1 = "[object Uint16Array]", uint32Tag$1 = "[object Uint32Array]";
var cloneableTags = {};
cloneableTags[argsTag$4] = cloneableTags[arrayTag$3] = cloneableTags[arrayBufferTag$3] = cloneableTags[dataViewTag$4] = cloneableTags[boolTag$3] = cloneableTags[dateTag$3] = cloneableTags[float32Tag$1] = cloneableTags[float64Tag$1] = cloneableTags[int8Tag$1] = cloneableTags[int16Tag$1] = cloneableTags[int32Tag$1] = cloneableTags[mapTag$5] = cloneableTags[numberTag$3] = cloneableTags[objectTag$4] = cloneableTags[regexpTag$5] = cloneableTags[setTag$5] = cloneableTags[stringTag$5] = cloneableTags[symbolTag$3] = cloneableTags[uint8Tag$1] = cloneableTags[uint8ClampedTag$1] = cloneableTags[uint16Tag$1] = cloneableTags[uint32Tag$1] = true;
cloneableTags[errorTag$3] = cloneableTags[funcTag$2] = cloneableTags[weakMapTag$2] = false;
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    if (tag == objectTag$4 || tag == argsTag$4 || isFunc && !object) {
...
var boolTag$2 = "[object Boolean]", dateTag$2 = "[object Date]", errorTag$2 = "[object Error]", mapTag$4 = "[object Map]", numberTag$2 = "[object Number]", regexpTag$4 = "[object RegExp]", setTag$4 = "[object Set]", stringTag$4 = "[object String]", symbolTag$2 = "[object Symbol]";
...
function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray$1(object), othIsArr = isArray$1(other), objTag = objIsArr ? arrayTag$2 : getTag$1(object), othTag = othIsArr ? arrayTag$2 : getTag$1(other);
...
var defaults = baseRest$1(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq$1(value, objectProto$i[key]) && !hasOwnProperty$f.call(object, key)) {
...
var difference = baseRest$1(function(array, values2) {
...
function filter(collection, predicate) {
  var func = isArray$1(collection) ? arrayFilter$1 : baseFilter;
  return func(collection, baseIteratee$1(predicate));
}
...
function baseIsRegExp$1(value) {
  return isObjectLike$1(value) && baseGetTag$1(value) == regexpTag$3;
}
...
function reject(collection, predicate) {
  var func = isArray$1(collection) ? arrayFilter$1 : baseFilter;
  return func(collection, negate(baseIteratee$1(predicate)));
}
...
var INFINITY$1 = 1 / 0;
var createSet = !(Set$2 && 1 / setToArray$1(new Set$2([, -0]))[1] == INFINITY$1) ? noop : function(values2) {
...
class RestWalker {
  walk(prod, prevRest = []) {
    forEach$1(prod.definition, (subProd, index) => {
  ...
  walkOr(orProd, currRest, prevRest) {
    const fullOrRest = currRest.concat(prevRest);
    forEach$1(orProd.definition, (alt) => {
...
function firstForBranching(prod) {
  const allAlternativesFirsts = map$1(prod.definition, (innerProd) => {
...
function computeAllProdsFollows(topProductions) {
  const reSyncFollows = {};
  forEach$1(topProductions, (topProd) => {
...
function findCode(setNode, targetCharCodes) {
  return find(setNode.value, (codeOrRange) => {
    if (typeof codeOrRange === "number") {
      return includes$1(targetCharCodes, codeOrRange);
    } else {
...
function isWholeOptional(ast) {
  ...
  return isArray$1(ast.value) ? every$1(ast.value, isWholeOptional) : isWholeOptional(ast.value);
}
class CharCodeFinder extends BaseRegExpVisitor {
  ...
  visitCharacter(node) {
    if (includes$1(this.targetCharCodes, node.value)) {
      this.found = true;
    }
  }
  visitSet(node) {
...
function canMatchCharCode(charCodes, pattern) {
  if (pattern instanceof RegExp) {
    ...
    return find(pattern, (char) => {
      return includes$1(charCodes, char.charCodeAt(0));
    }) !== void 0;
  }
}
...
function analyzeTokenTypes(tokenTypes, options) {
  ...
  tracer("Transform Patterns", () => {
    hasCustom = false;
    allTransformedPatterns = map$1(onlyRelevantTypes, (currType) => {
  ...
  tracer("misc mapping", () => {
    patternIdxToType = map$1(onlyRelevantTypes, (currType) => currType.tokenTypeIdx);
    patternIdxToGroup = map$1(onlyRelevantTypes, (clazz) => {
    ...
    patternIdxToLongerAltIdxArr = map$1(onlyRelevantTypes, (clazz) => {
      const longerAltType = clazz.LONGER_ALT;
      if (longerAltType) {
        const longerAltIdxArr = isArray$1(longerAltType) ? map$1(longerAltType, (type) => indexOf(onlyRelevantTypes, type)) : [indexOf(onlyRelevantTypes, longerAltType)];
        return longerAltIdxArr;
      }
    });
    patternIdxToPushMode = map$1(onlyRelevantTypes, (clazz) => clazz.PUSH_MODE);
    patternIdxToPopMode = map$1(onlyRelevantTypes, (clazz) => has(clazz, "POP_MODE"));
  });
  let patternIdxToCanLineTerminator;
  tracer("Line Terminator Handling", () => {
    const lineTerminatorCharCodes = getCharCodes(options.lineTerminatorCharacters);
    patternIdxToCanLineTerminator = map$1(onlyRelevantTypes, (tokType) => false);
    if (options.positionTracking !== "onlyOffset") {
      patternIdxToCanLineTerminator = map$1(onlyRelevantTypes, (tokType) => {
  ...
  tracer("Misc Mapping #2", () => {
    patternIdxToIsCustom = map$1(onlyRelevantTypes, isCustomPattern);
    patternIdxToShort = map$1(allTransformedPatterns, isShortPattern);
    ...
    patternIdxToConfig = map$1(allTransformedPatterns, (x, idx) => {
      return {
    ...
    tracer("First Char Optimization", () => {
      charCodeToPatternIdxToConfig = reduce(onlyRelevantTypes, (result, currTokType, idx) => {
        if (typeof currTokType.PATTERN === "string") {
          ...
          forEach$1(currTokType.START_CHARS_HINT, (charOrInt) => {
...
function findMissingPatterns(tokenTypes) {
  ...
  const errors = map$1(tokenTypesWithMissingPattern, (currType) => {
    return {
...
function findInvalidPatterns(tokenTypes) {
  const tokenTypesWithInvalidPattern = filter(tokenTypes, (currType) => {
    ...
    return !isRegExp$1(pattern) && !isFunction$1(pattern) && !has(pattern, "exec") && !isString$1(pattern);
  });
  const errors = map$1(tokenTypesWithInvalidPattern, (currType) => {
    return {
...
function findEndOfInputAnchor(tokenTypes) {
  ...
  const errors = map$1(invalidRegex, (currType) => {
    return {
...
function findEmptyMatchRegExps(tokenTypes) {
  ...
  const errors = map$1(matchesEmptyString, (currType) => {
    return {
...
function findUnsupportedFlags(tokenTypes) {
  ...
  const errors = map$1(invalidFlags, (currType) => {
    return {
...
function findDuplicatePatterns(tokenTypes) {
  const found = [];
  let identicalPatterns = map$1(tokenTypes, (outerType) => {
    return reduce(tokenTypes, (result, innerType) => {
      if (outerType.PATTERN.source === innerType.PATTERN.source && !includes$1(found, innerType) && innerType.PATTERN !== Lexer.NA) {
  ...
  const errors = map$1(duplicatePatterns, (setOfIdentical) => {
    const tokenTypeNames = map$1(setOfIdentical, (currType) => {
...
function findInvalidGroupType(tokenTypes) {
  ...
  const errors = map$1(invalidTypes, (currType) => {
    return {
...
function findModesThatDoNotExist(tokenTypes, validModes) {
  const invalidModes = filter(tokenTypes, (clazz) => {
    return clazz.PUSH_MODE !== void 0 && !includes$1(validModes, clazz.PUSH_MODE);
  });
  const errors = map$1(invalidModes, (tokType) => {
...
function findUnreachablePatterns(tokenTypes) {
  ...
  forEach$1(tokenTypes, (tokType, testIdx) => {
    forEach$1(canBeTested, ({ str, idx, tokenType }) => {
...
`,
  ...
  if (has(lexerDefinition, MODES)) {
    forEach$1(lexerDefinition.modes, (currModeValue, currModeName) => {
      forEach$1(currModeValue, (currTokType, currIdx) => {
...
`,
          ...
          forEach$1(longerAlt, (currLongerAlt) => {
            if (!isUndefined(currLongerAlt) && !includes$1(currModeValue, currLongerAlt)) {
              errors.push({
...
function performWarningRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
  ...
  if (trackLines) {
    forEach$1(concreteTokenTypes, (tokType) => {
...
function cloneEmptyGroups(emptyGroups) {
  const clonedResult = {};
  const groupKeys = keys$1(emptyGroups);
  forEach$1(groupKeys, (currKey) => {
...
function getCharCodes(charsOrCodes) {
  const charCodes = map$1(charsOrCodes, (numOrString) => {
...
function augmentTokenTypes(tokenTypes) {
  ...
  forEach$1(tokenTypesAndParents, (tokType) => {
...
function expandCategories(tokenTypes) {
  ...
  let searching = true;
  while (searching) {
    categories = compact(flatten(map$1(categories, (currTokType) => currTokType.CATEGORIES)));
...
function assignTokenDefaultProps(tokenTypes) {
  forEach$1(tokenTypes, (currTokType) => {
...
function assignCategoriesTokensProp(tokenTypes) {
  forEach$1(tokenTypes, (currTokType) => {
    currTokType.categoryMatches = [];
    forEach$1(currTokType.categoryMatchesMap, (val, key) => {
...
function singleAssignCategoriesToksMap(path, nextNode) {
  forEach$1(path, (pathNode) => {
    nextNode.categoryMatchesMap[pathNode.tokenTypeIdx] = true;
  });
  forEach$1(nextNode.CATEGORIES, (nextCategory) => {
    const newPath = path.concat(nextNode);
    if (!includes$1(newPath, nextCategory)) {
...
class Lexer {
  constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
    ...
    this.TRACE_INIT("Lexer Constructor", () => {
      ...
      forEach$1(actualDefinition.modes, (currModeValue, currModeName) => {
        actualDefinition.modes[currModeName] = reject(currModeValue, (currTokType) => isUndefined(currTokType));
      });
      const allModeNames = keys$1(actualDefinition.modes);
      forEach$1(actualDefinition.modes, (currModDef, currModName) => {
      ...
      if (!isEmpty(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
        const allErrMessages = map$1(this.lexerDefinitionErrors, (error) => {
          return error.message;
        });
        const allErrMessagesString = allErrMessages.join("-----------------------\n");
        throw new Error("Errors detected in definition of Lexer:\n" + allErrMessagesString);
      }
      forEach$1(this.lexerDefinitionWarning, (warningDescriptor) => {
        PRINT_WARNING(warningDescriptor.message);
      });
      this.TRACE_INIT("Choosing sub-methods implementations", () => {
        if (SUPPORT_STICKY) {
          this.chopInput = identity$1;
        ...
        if (this.trackStartLines === false) {
          this.computeNewColumn = identity$1;
        }
...
const defaultParserErrorProvider = {
  ...
  buildNoViableAltMessage({ expectedPathsPerAlt, actual, previous, customUserDescription, ruleName }) {
    ...
    if (customUserDescription) {
      ...
      const nextValidTokenSequences = map$1(allLookAheadPaths, (currPath) => `[${map$1(currPath, (currTokenType) => tokenLabel(currTokenType)).join(", ")}]`);
      const nextValidSequenceItems = map$1(nextValidTokenSequences, (itemMsg, idx) => `  ${idx + 1}. ${itemMsg}`);
...
${nextValidSequenceItems.join("\n")}`;
  ...
  buildEarlyExitMessage({ expectedIterationPaths, actual, customUserDescription, ruleName }) {
    ...
    if (customUserDescription) {
      ...
      const nextValidTokenSequences = map$1(expectedIterationPaths, (currPath) => `[${map$1(currPath, (currTokenType) => tokenLabel(currTokenType)).join(",")}]`);
...
<OR${options.alternation.idx}> inside <${options.topLevelRule.name}> Rule.
 has ${options.alternation.definition.length + 1} alternatives.`;
  ...
  buildLeftRecursionError(options) {
    ...
    const pathNames = map$1(options.leftRecursionPath, (currRule) => currRule.name);
...
class GastRefResolverVisitor extends GAstVisitor {
  ...
  resolveRefs() {
    forEach$1(values$1(this.nameToTopRule), (prod) => {
...
function possiblePathsFrom(targetDef, maxLength, currPath = []) {
  ...
  while (currPath.length < maxLength && i < targetDef.length) {
    ...
    if (prod instanceof Alternative) {
      ...
      forEach$1(prod.definition, (currAlt) => {
...
function buildAlternativesLookAheadFunc(alts, hasPredicates, tokenMatcher2, dynamicTokensEnabled) {
  ...
  const areAllOneTokenLookahead = every$1(alts, (currAlt) => {
    return every$1(currAlt, (currPath) => {
      return currPath.length === 1;
    });
  });
  if (hasPredicates) {
    return function(orAlts) {
      const predicates = map$1(orAlts, (currAlt) => currAlt.GATE);
    ...
    const singleTokenAlts = map$1(alts, (currAlt) => {
...
function buildSingleAlternativeLookaheadFunction(alt, tokenMatcher2, dynamicTokensEnabled) {
  const areAllOneTokenLookahead = every$1(alt, (currPath) => {
    return currPath.length === 1;
  });
...
function lookAheadSequenceFromAlternatives(altsDefs, k) {
  const partialAlts = map$1(altsDefs, (currAlt) => possiblePathsFrom([currAlt], 1));
  const finalResult = initializeArrayOfArrays(partialAlts.length);
  const altsHashes = map$1(partialAlts, (currAltPaths) => {
    const dict = {};
    forEach$1(currAltPaths, (item) => {
      const keys2 = pathToHashKeys(item.partialPath);
      forEach$1(keys2, (currKey) => {
        dict[currKey] = true;
      });
    });
    return dict;
    ...
    for (let altIdx = 0; altIdx < currDataset.length; altIdx++) {
      ...
      for (let currPathIdx = 0; currPathIdx < currAltPathsAndSuffixes.length; currPathIdx++) {
        ...
        if (isUnique || isEmpty(suffixDef) || currPathPrefix.length === k) {
          ...
          forEach$1(newPartialPathsAndSuffixes, (item) => {
            const prefixKeys2 = pathToHashKeys(item.partialPath);
            forEach$1(prefixKeys2, (key) => {
...
function isStrictPrefixOfPath(prefix, other) {
  return prefix.length < other.length && every$1(prefix, (tokType, idx) => {
    const otherTokType = other[idx];
    return tokType === otherTokType || otherTokType.categoryMatchesMap[tokType.tokenTypeIdx];
  });
}
function areTokenCategoriesNotUsed(lookAheadPaths) {
  return every$1(lookAheadPaths, (singleAltPaths) => every$1(singleAltPaths, (singlePath) => every$1(singlePath, (token) => isEmpty(token.categoryMatches))));
}
function validateLookahead(options) {
  ...
  return map$1(lookaheadValidationErrorMessages, (errorMessage) => Object.assign({ type: ParserDefinitionErrorType.CUSTOM_LOOKAHEAD_VALIDATION }, errorMessage));
}
...
function validateDuplicateProductions(topLevelRule, errMsgProvider) {
  ...
  const duplicates = pickBy$1(productionGroups, (currGroup) => {
    return currGroup.length > 1;
  });
  const errors = map$1(values$1(duplicates), (currDuplicates) => {
...
function validateRuleIsOverridden(ruleName, definedRulesNames, className) {
  const errors = [];
  let errMsg;
  if (!includes$1(definedRulesNames, ruleName)) {
...
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
  ...
  if (isEmpty(nextNonTerminals)) {
    ...
    const foundLeftRecursion = includes$1(nextNonTerminals, topRule);
...
function getFirstNoneTerminal(definition) {
  ...
  if (firstProd instanceof NonTerminal) {
    ...
    result = flatten(map$1(firstProd.definition, (currSubDef) => getFirstNoneTerminal(currSubDef.definition)));
...
function checkAlternativesAmbiguities(alternatives, alternation2, rule, errMsgProvider) {
  ...
  const identicalAmbiguities = reduce(alternatives, (result, currAlt, currAltIdx) => {
    ...
    forEach$1(currAlt, (currPath) => {
      const altsCurrPathAppearsIn = [currAltIdx];
      forEach$1(alternatives, (currOtherAlt, currOtherAltIdx) => {
  ...
  const currErrors = map$1(identicalAmbiguities, (currAmbDescriptor) => {
    const ambgIndices = map$1(currAmbDescriptor.alts, (currAltIdx) => currAltIdx + 1);
...
function checkPrefixAlternativesAmbiguities(alternatives, alternation2, rule, errMsgProvider) {
  const pathsAndIndices = reduce(alternatives, (result, currAlt, idx) => {
    const currPathsAndIdx = map$1(currAlt, (currPath) => {
  ...
  const errors = compact(flatMap(pathsAndIndices, (currPathAndIdx) => {
    ...
    const currPathPrefixErrors = map$1(prefixAmbiguitiesPathsAndIndices, (currAmbPathAndIdx) => {
...
function checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider) {
  const errors = [];
  const tokenNames = map$1(tokenTypes, (currToken) => currToken.name);
  forEach$1(topLevels, (currRule) => {
    const currRuleName = currRule.name;
    if (includes$1(tokenNames, currRuleName)) {
...
function isRecognitionException(error) {
  return includes$1(RECOGNITION_EXCEPTION_NAMES, error.name);
}
...
class Recoverable {
  ...
  isInCurrentRuleReSyncSet(tokenTypeIdx) {
    ...
    return includes$1(currentRuleReSyncSet, tokenTypeIdx);
  }
  findReSyncTokenType() {
  ...
  buildFullFollowKeyStack() {
    ...
    return map$1(explicitRuleStack, (ruleName, idx) => {
      if (idx === 0) {
        return EOF_FOLLOW_KEY;
      }
      return {
  ...
  flattenFollowSet() {
    const followStack = map$1(this.buildFullFollowKeyStack(), (currKey) => {
  ...
  getHumanReadableRuleStack() {
    return map$1(this.RULE_STACK, (currShortName) => this.shortRuleNameToFullName(currShortName));
  }
}
  ...
  preComputeLookaheadFunctions(rules) {
    forEach$1(rules, (currRule) => {
      this.TRACE_INIT(`${currRule.name} Rule Lookahead`, () => {
        ...
        forEach$1(alternation2, (currProd) => {
        ...
        forEach$1(repetition2, (currProd) => {
        ...
        forEach$1(repetitionMandatoryWithSeparator, (currProd) => {
        ...
        forEach$1(repetitionWithSeparator, (currProd) => {
...
function defaultVisit(ctx, param) {
  const childrenNames = keys$1(ctx);
  ...
  const semanticProto = {
    ...
    validateVisitor: function() {
      ...
      if (!isEmpty(semanticDefinitionErrors)) {
        const errorMessages = map$1(semanticDefinitionErrors, (currDefError) => currDefError.msg);
...
function validateMissingCstMethods(visitorInstance, ruleNames) {
  const missingRuleNames = filter(ruleNames, (currRuleName) => {
    return isFunction$1(visitorInstance[currRuleName]) === false;
  });
  const errors = map$1(missingRuleNames, (currRuleName) => {
    return {
...
class TreeBuilder {
  ...
  getBaseCstVisitorConstructor() {
    if (isUndefined(this.baseCstVisitorConstructor)) {
      const newBaseCstVisitorConstructor = createBaseSemanticVisitorConstructor(this.className, keys$1(this.gastProductionsCache));
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (isUndefined(this.baseCstVisitorWithDefaultsConstructor)) {
      const newConstructor = createBaseVisitorConstructorWithDefaults(this.className, keys$1(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
class RecognizerApi {
  ...
  RULE(name, implementation, config = DEFAULT_RULE_CONFIG) {
    if (includes$1(this.definedRulesNames, name)) {
...
class RecognizerEngine {
  initRecognizerEngine(tokenVocabulary, config) {
    ...
    } else if (has(tokenVocabulary, "modes") && every$1(flatten(values$1(tokenVocabulary.modes)), isTokenType)) {
    ...
    const noTokenCategoriesUsed = every$1(allTokenTypes, (tokenConstructor) => isEmpty(tokenConstructor.categoryMatches));
...
function recordProd(prodConstructor, mainProdArg, occurrence, handleSep = false) {
  assertMethodIdxIsValid(occurrence);
  const prevProd = last(this.recordingProdStack);
  const grammarAction = isFunction$1(mainProdArg) ? mainProdArg : mainProdArg.DEF;
...
function recordOrProd(mainProdArg, occurrence) {
  ...
  const hasPredicates = some$1(alts, (currAlt) => isFunction$1(currAlt.GATE));
  newOrProd.hasPredicates = hasPredicates;
  prevProd.definition.push(newOrProd);
  forEach$1(alts, (currAlt) => {
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      this.TRACE_INIT("Grammar Recording", () => {
        try {
          ...
          forEach$1(this.definedRulesNames, (currRuleName) => {
      ...
      if (!Parser.DEFER_DEFINITION_ERRORS_HANDLING && !isEmpty(this.definitionErrors)) {
        defErrorsMsgs = map$1(this.definitionErrors, (defError) => defError.message);
...
function alternation(atn, rule, alternation2) {
  ...
  const alts = map$2(alternation2.definition, (e) => atom(atn, rule, e));
...
function block(atn, rule, block2) {
  const handles = filter$1(map$2(block2.definition, (e) => atom(atn, rule, e)), (e) => e !== void 0);
  if (handles.length === 1) {
    return handles[0];
...
class ATNConfigSet {
  ...
  get alts() {
    return map$2(this.configs, (e) => e.alt);
  }
  get key() {
    let value = "";
...
class LLStarLookaheadStrategy extends LLkLookaheadStrategy {
  ...
  buildLookaheadForAlternation(options) {
    ...
    const partialAlts = map$2(getLookaheadPaths({
      maxLookahead: 1,
      occurrence: prodOccurrence,
      prodType: "Alternation",
      rule
    }), (currAlt) => map$2(currAlt, (path) => path[0]));
    if (isLL1Sequence(partialAlts, false) && !dynamicTokensEnabled) {
      const choiceToAlt = reduce$1(partialAlts, (result, currAlt, idx) => {
        forEach$2(currAlt, (currTokType) => {
          if (currTokType) {
            result[currTokType.tokenTypeIdx] = idx;
            forEach$2(currTokType.categoryMatches, (currExtendingType) => {
              result[currExtendingType] = idx;
            });
          }
        });
  ...
  buildLookaheadForOptional(options) {
    ...
    const decisionState = this.atn.decisionMap[key];
    const decisionIndex = decisionState.decision;
    const alts = map$2(getLookaheadPaths({
      maxLookahead: 1,
      occurrence: prodOccurrence,
      prodType,
      rule
    }), (e) => {
      return map$2(e, (g) => g[0]);
    });
...
function buildAmbiguityError(options) {
  const pathMsg = map$2(options.prefixPath, (currtok) => tokenLabel(currtok)).join(", ");
...
const DatatypeSymbol = /* @__PURE__ */ Symbol("Datatype");
...
const OperationCancelled = /* @__PURE__ */ Symbol("OperationCancelled");
...
(() => {
  var t = { 470: (t2) => {
    ...
    var n2 = { resolve: function() {
      for (var t3, n3 = "", i = false, o = arguments.length - 1; o >= -1 && !i; o--) {
        var s;
        o >= 0 ? s = arguments[o] : (void 0 === t3 && (t3 = process$1.cwd()), s = t3), e2(s), 0 !== s.length && (n3 = s + "/" + n3, i = 47 === s.charCodeAt(0));
      }
  ...
  (() => {
    let t2;
    if (r.r(n), r.d(n, { URI: () => f, Utils: () => P }), "object" == typeof process$1) t2 = "win32" === process$1.platform;
...
const ref_resolving = /* @__PURE__ */ Symbol("ref_resolving");
class DefaultLinker {
  constructor(services) {
...
const isProxy = /* @__PURE__ */ Symbol("isProxy");
...
const __requested__ = /* @__PURE__ */ Symbol();
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
      const { createInfoServices: createInfoServices22 } = await Promise.resolve().then(() => infoNVLQJR56);
  ...
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
      const { createPacketServices: createPacketServices22 } = await Promise.resolve().then(() => packetBFZMPI3H);
  ...
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
      const { createPieServices: createPieServices22 } = await Promise.resolve().then(() => pie7BOR55EZ);
  ...
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
      const { createArchitectureServices: createArchitectureServices22 } = await Promise.resolve().then(() => architectureU656AL7Q);
  ...
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
      const { createGitGraphServices: createGitGraphServices22 } = await Promise.resolve().then(() => gitGraphF6HP7TQM);
  ...
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => {
      const { createRadarServices: createRadarServices22 } = await Promise.resolve().then(() => radarNHE76QYJ);
  ...
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => {
      const { createTreemapServices: createTreemapServices22 } = await Promise.resolve().then(() => treemapKMMF4GRG);
